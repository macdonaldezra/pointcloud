...
class PointTransformerLayer(nn.Module):
    """
    This model has been retrieved from this repository: https://github.com/POSTECH-CVLab/point-transformer

    which is an implementation based on the Point Transformer paper which can be found here:
